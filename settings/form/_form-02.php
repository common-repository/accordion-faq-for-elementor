    ...
    <div id="tab-1">
        <div class="row afaq_6310_padding_15_px">
            ...
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <select name="afaq_faq_mode" class="afaq-6310-form-input" id="afaq_faq_mode">
                    ...
                    <option value="2" <?php if ($cssData['afaq_faq_mode'] == '2') echo " selected=''" ?>>All Open (Pro)</option>
                    <option value="3" <?php if ($cssData['afaq_faq_mode'] == '3') echo " selected=''" ?>>All Folded (Pro)</option>
                  </select>
                </td>
              </tr>       
              <tr class="enable-collapsable">
                <td>
                  ...
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                  <div class="afaq-6310-sub-title">Check to open multiple FAQs together.</div>
                </td>
                <td>
                  <label class="switch">
          ...
          <div class="afaq-6310-tab-6">
            <table class="table table-responsive afaq_6310_admin_table">
              <tr>
                <td><b> Indicator Active Icon</b></td>
                <td>
              ...
              <tr>
                <td><b>Indicator Inactive Icon</b></td>
                <td>
              ...
              <tr class="description-act-field">
                <td><b>Indicator Hover Color</b></td>
                <td>
              ...
              <tr class="description-act-field">
                <td><b>Indicator Background Color</b></td>
                <td>
              ...
              <tr class="description-act-field">
                <td><b>Indicator Background Hover Color</b></td>
                <td>
          ...
          <div class="afaq-6310-tab-6">
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr class="description-act-field">
                <td><b>Background Color</b></td>
                <td>
                  <input type="text" name="description_font_background_color" id="description_font_background_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" data-opacity="0.08" value="<?php echo $cssData['description_font_background_color'] ?>">
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Background Hover Color</b></td>
                <td>
                  <input type="text" name="description_background_hover_color" id="description_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" data-opacity="0.08" value="<?php echo $cssData['description_background_hover_color'] ?>">
                </td>
              </tr>
