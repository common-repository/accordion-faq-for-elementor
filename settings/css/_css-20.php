<?php 
$display = ceil($cssData['indicator_width_number'] / 2);
...
.afaq-6310-faq-template-<?php echo $ids; ?>-head-title {
  ...
  display: flex;
  box-sizing: inherit;  
  margin-left: <?php echo ceil($cssData['indicator_width_number'] / 2)?>px;
...
.afaq-6310-faq-template-<?php echo $ids; ?>-head-left-icon {
  ...
  background: <?php echo $cssData['indicator_background_color'] ?>;
  color: <?php echo $cssData['indicator_color'] ?>;
  border-radius: 50%;
  border: <?php echo $cssData['indicator_border_size'] ?>px solid #fff;
  top: calc(50% - <?php echo ceil($cssData['indicator_width_number'] / 2)?>px); 
  left: -<?php echo ceil($cssData['indicator_width_number'] / 2)?>px;
  transition: 0.4s;
...
.afaq-6310-faq-template-<?php echo $ids; ?>-head-left-icon {
  ...
  background: <?php echo $cssData['indicator_hover_background_color'] ?>;
...
.afaq-6310-faq-template-<?php echo $ids?>-active .afaq-6310-faq-template-<?php echo $ids; ?>-head-left-icon {
  transform: rotate(360deg);
  background: <?php echo $cssData['indicator_hover_background_color'] ?> !important;
