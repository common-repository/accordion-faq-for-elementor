      ...
      <div class="afaq-6310-plugin-setting-left">
         ...
         <div class="afaq_6310_tabs_panel_preview">
            <div 
               ...
               data-icon-class="afaq-6310-faq-template-<?php echo $ids; ?>-head-right-title-icon" 
            ...
            >
               ...
               ?>
                     <div class="afaq-6310-faq-template-<?php echo $ids . afaq_6310_explode_class_code($faq['class_code']); ?>">
                        ...
                        <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon"><i class="<?php echo $faq['icons_name'] ?>"></i></div>
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title">                              
                              <?php echo afaq_6310_scRemove($faq['title']) ?>                             
                           </div>
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-right-title-icon"><i class="<?php echo $cssData['title_inactive_icon'] ?>"></i></div>
                        </div>
