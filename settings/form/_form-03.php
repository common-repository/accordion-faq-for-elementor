        ...
        <div class="row">
          ...
          <div class="afaq-6310-tab-6">
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr>
                <td><b>Spacing from left</b>
                  </td>
                <td>
                  <input name="title_empty_space" id="title_empty_space" min="0" type="number" value="<?php echo $cssData['title_empty_space'] ?>" class="afaq-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="afaq-6310-tab-6">
            ...
            <tr>
              ...
              <tr class="description-act-field description_scroll">
                <td><b>Description Scroll </b><br /><div class="afaq-6310-pro" style="display: block;">*Preview-on-change not available</div>
                  </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="description_border_height" value="<?php echo $cssData['description_border_height'] ?>" class="afaq-6310-form-input" id="description_border_height" />
                </td>
              </tr>
              <tr>
                <td><b>Border Color</b>
                ...
                <td>
                  <input type="text" name="description_border_color" id="description_border_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['description_border_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="afaq-6310-tab-6">
            ...
            <tr class="description-act-field">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="description_border_hover_color" id="description_border_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['description_border_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
