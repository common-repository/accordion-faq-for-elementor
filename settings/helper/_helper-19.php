<script type="text/javascript">
       jQuery(document).ready(function() {
        ...
        `).on('change', function() {
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-label-head {
               margin-top: ${body_margin_bottom}px;
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon {
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-label-head:hover .afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon {
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-content::after {
              border-bottom: 15px solid ${description_font_background_color};
            }</styles>`).appendTo(".afaq-6310-preview");
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids?>-active .afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon {
    ...
    function calculateWidth() {      
            ...
            if (jQuery('#icon_show_hide').prop('checked') == true) {
                ...
                jQuery("<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon{ display:flex;}</style>").appendTo(".afaq-6310-preview");
            } else {
                jQuery('.title-act-field').hide();
                jQuery("<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-head-left-title-icon { display:none;}</style>").appendTo(".afaq-6310-preview");
            }
