<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        `).on('change', function() {
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon{
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-label-head:hover .afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon{
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-head-title {
               ...
               width: calc(100% - `+ (indicator_width_number + title_empty_space)+`px);
                background-color: ${title_bg_color} !important;
               border-top: ${top_border_height_number}px solid ${title_border_top_color};
            }</style>`).appendTo(".afaq-6310-preview");  

            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-title-heading{
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-label-head:hover .afaq-6310-faq-template-<?php echo $ids; ?>-title-heading{
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-content {
               ...
               width: calc(100% - `+(indicator_width_number + title_empty_space)+`px);
               margin-left: `+ (indicator_width_number + title_empty_space)+`px;
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids?>-active .afaq-6310-faq-template-<?php echo $ids; ?>-title-heading{
            ...
            jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids?>-active .afaq-6310-faq-template-<?php echo $ids;?>-left-icon{
                ...
                jQuery(`<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-active .afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon {
                     color:${icon_hover_color} !important;
                     background-color: ${icon_background_hover_color} !important;
                }</style>`).appendTo(".afaq-6310-preview");
        });
        ...
        function calculateWidth() {
            ...
            if (jQuery('#icon_show_hide').prop('checked') == true) {
                ...
                jQuery("<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon{ display:flex;}</style>").appendTo(".afaq-6310-preview");
            } else {
                jQuery('.title-act-field').hide();
                jQuery("<style type='text/css'>.afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon { display:none;}</style>").appendTo(".afaq-6310-preview");
            }
