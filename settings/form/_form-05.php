            ...
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr>
                <td><b>Angle Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="before_effect_color" id="before_effect_color" class="afaq-6310-form-input afaq_6310_color_picker"  data-format="rgb"  value="<?php echo $cssData['before_effect_color'] ?>">
                </td>
              </tr> 
              <tr>
                <td><b>Angle hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="before_effect_hover_color" id="before_effect_hover_color" class="afaq-6310-form-input afaq_6310_color_picker"  data-format="rgb"  value="<?php echo $cssData['before_effect_hover_color'] ?>">
                </td>
              </tr> 
              <tr>
                <td><b>Angle Width</b>
            ...
            <table class="table table-responsive afaq_6310_admin_table">              
              ...
              <tr class="description-act-field">
                <td><b>Indicator Background Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_background_color" id="indicator_background_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" data-opacity="0.8"  value="<?php echo $cssData['indicator_background_color'] ?>">
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Indicator Background Hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_background_hover_color" id="indicator_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb"  data-opacity="0.8" value="<?php echo $cssData['indicator_background_hover_color'] ?>">
                </td>
              </tr>
            ...
            <tr class="description-act-field">
              ...
              <tr class="description-act-field">
                <td><b>Background Hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="description_background_hover_color" id="description_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" data-opacity="0.8" value="<?php echo $cssData['description_background_hover_color'] ?>">
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Padding Left</b>
