   ...
   <div class="afaq-6310-sm">
      <div class="afaq-6310-plugin-setting-left">
         ...
         <div class="afaq_6310_tabs_panel_preview">
            <div class="afaq-6310-faq-for-elementor-<?php echo $ids; ?> afaq-6310-faq-for-elementor" 
            data-up-arrow="<?php echo $cssData['title_active_icon'] ?>" 
            data-down-arrow="<?php echo $cssData['title_inactive_icon'] ?>"
            data-icon-class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title-icon-section" 
            data-database-id='<?php echo $ids; ?>' 
            data-search-template-show-hide-id='<?php echo isset($cssData['search_template_show_hide']) ? 1 : 0 ?>' data-category-active='<?php echo isset($cssData['category_template_show_hide']) ? 1 : 0 ?>'
               ...
               ?>
                  <div class="afaq-6310-faq-template-<?php echo $ids .afaq_6310_explode_class_code($faq['class_code']); ?>">
                     <div class="afaq-6310-faq-template-<?php echo $ids; ?>-label-head <?php if ($i++ == 1) {echo "afaq-6310-faq-template-{$ids}-active"; } ?>">
                        ...
                        <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title">
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title-section"><?php echo afaq_6310_scRemove($faq['title']) ?> </div>
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title-icon-section"><i class="<?php echo $cssData['title_inactive_icon'] ?>"></i></div>
                        </div>
                     </div>
