        ...
        <div class="row afaq_6310_padding_15_px">
            ...
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr class="title-act-field">
                <td><b>Icon Background Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="icon_background_color" id="icon_background_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['icon_background_color'] ?>">
                </td>
              </tr>
              <tr class="title-act-field">
                <td><b>Icon Background Hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="icon_background_hover_color" id="icon_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['icon_background_hover_color'] ?>">
                </td>
              </tr>
              <tr class="title-act-field">
                <td><b>Icon Border</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="head_icon_border_size" value="<?php echo $cssData['head_icon_border_size'] ?>" class="afaq-6310-form-input" id="head_icon_border_size" />
                </td>
              </tr>
            </table>
          </div>
          <div class="afaq-6310-tab-6">
            <table class="table table-responsive afaq_6310_admin_table">
              ...
              <tr class="description-act-field">
                <td><b>Indicator Background Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_background_color" id="indicator_background_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['indicator_background_color'] ?>">
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Indicator Background Hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="indicator_background_hover_color" id="indicator_background_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['indicator_background_hover_color'] ?>">
                </td>
              </tr>
              <tr class="title-act-field">
                <td><b>Icon Border Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="title_icon_border_color" id="title_icon_border_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['title_icon_border_color'] ?>">
                </td>
              </tr>
              <tr class="title-act-field">
                <td><b>Icon Border hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="title_icon_border_hover_color" id="title_icon_border_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['title_icon_border_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
            ...
            <tr>
              ...
              <tr>
                <td><b>Margin Bottom</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="title_margin_bottom" id="title_margin_bottom" min="10" type="number" value="<?php echo $cssData['title_margin_bottom'] ?>" class="afaq-6310-form-input" />
                </td>
              </tr>
            ...
            <table class="table table-responsive afaq_6310_admin_table">             
              ...
              <tr class="description-act-field">
                <td><b>Margin Bottom </b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="description_margin_bottom" value="<?php echo $cssData['description_margin_bottom'] ?>" class="afaq-6310-form-input" step="1" id="description_margin_bottom" />
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Border Bottom Height </b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="number" min="0" name="description_border_bottom" value="<?php echo $cssData['description_border_bottom'] ?>" class="afaq-6310-form-input" step="1" id="description_border_bottom" />
                </td>
              </tr>
              <tr class="description-act-field">
                <td><b>Border Bottom Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="description_border_bottom_color" id="description_border_bottom_color" class="afaq-6310-form-input afaq_6310_color_picker" data-format="rgb" value="<?php echo $cssData['description_border_bottom_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b> Description Background Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="description_bg_color" id="description_bg_color" class="afaq-6310-form-input afaq_6310_color_picker" data-opacity="0.08" data-format="rgb" value="<?php echo $cssData['description_bg_color'] ?>">
                </td>
              </tr>
              <tr>
                <td><b>  Description Background  Hover Color</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="description_bg_hover_color" id="description_bg_hover_color" class="afaq-6310-form-input afaq_6310_color_picker" data-opacity="0.08" data-format="rgb"  value="<?php echo $cssData['description_bg_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
