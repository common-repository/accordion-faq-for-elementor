...
.afaq-6310-faq-template-<?php echo $ids; ?>-left-icon {
  ...
  padding-right: <?php echo ceil($cssData['indicator_width_number']/5) ?>px;
  text-align: center; 
  display: flex;
...
.afaq-6310-faq-template-<?php echo $ids; ?>-left-icon::after {
  ...
  bottom: 0;
  background-color: <?php echo $cssData['before_effect_color'] ?>;
  transform: skewX(28deg);
  z-index: 1;
}
.afaq-6310-faq-template-<?php echo $ids; ?>-label-head:hover .afaq-6310-faq-template-<?php echo $ids; ?>-left-icon::before {
  background-color: <?php echo $cssData['before_effect_hover_color'] ?>;
}
