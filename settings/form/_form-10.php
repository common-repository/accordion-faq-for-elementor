            ...
            <table class="table table-responsive afaq_6310_admin_table">  
              <tr>
                ...
                <tr class="description-act-field description_scroll">
                    <td><b>Description Scroll </b><br /><span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><div class="afaq-6310-pro" style="display: block;">*Preview-on-change not available</div>
                  </td>
                  <td>
              ...
              <tr class="description-act-field">
                <td><b>Margin top</b>
                  <span class="afaq-6310-pro">(Pro) <div class='afaq-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="description_margin_top" id="description_margin_top" type="number" value="<?php echo $cssData['description_margin_top'] ?>" class="afaq-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
