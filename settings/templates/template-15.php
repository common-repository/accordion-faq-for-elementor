   ...
   <div class="afaq-6310-sm">
      <div class="afaq-6310-plugin-setting-left">
         ...
         <div class="afaq_6310_tabs_panel_preview">
            <div 
               class="afaq-6310-faq-for-elementor-<?php echo $ids; ?> afaq-6310-faq-for-elementor afaq-6310-template-15" 
            ...
            >
               ...
               ?>
                     <div class="afaq-6310-faq-template-<?php echo $ids . afaq_6310_explode_class_code($faq['class_code']); ?>">
                        <div class="afaq-6310-faq-template-<?php echo $ids; ?>-left-section">
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-arrow">
                              <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-arrow-before"></div>
                              <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-arrow-after"></div>
                              <?php echo $i?>
                           </div>
                        </div>
                        <div class="afaq-6310-faq-template-<?php echo $ids; ?>-right-section ">
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-label-head <?php if ($i++ == 1) {echo "afaq-6310-faq-template-{$ids}-active"; } ?> ">
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-left-icon"><i class="<?php echo $faq['icons_name'] ?>"></i></div>
