      ...
      <div class="afaq-6310-plugin-setting-left">
         ...
         <div class="afaq_6310_tabs_panel_preview">
            <div 
               ...
               data-icon-class="afaq-6310-faq-template-<?php echo $ids; ?>-left-icon" 
               ...
               ?>
                     <div class="afaq-6310-faq-template-<?php echo $ids .afaq_6310_explode_class_code($faq['class_code']); ?>">
                           <div class="afaq-6310-faq-template-<?php echo $ids; ?>-label-head <?php if ($i++ == 1) {echo "afaq-6310-faq-template-{$ids}-active"; } ?>">
                              <div class="afaq-6310-faq-template-<?php echo $ids; ?>-left-icon"><i class="<?php echo $cssData['title_inactive_icon'] ?>"></i></div>
                              <div class="afaq-6310-faq-template-<?php echo $ids; ?>-head-title">  <div class="afaq-6310-faq-template-<?php echo $ids; ?>-title-left-icon"><i class="<?php echo $faq['icons_name'] ?>"></i></div>
                              <div class="afaq-6310-faq-template-<?php echo $ids; ?>-title-heading"> <?php echo afaq_6310_scRemove($faq['title']) ?></div>
                              </div>
                           </div>
